...
resource "aws_s3_bucket_object" "app" {
    ...
    etag = "${filemd5("../webpack/build/app.js")}"
...
resource "aws_s3_bucket_object" "endorsements" {
    ...
    etag = "${filemd5("../webpack/build/endorsements.html")}"
    cache_control = "max_age=86400"
...
resource "aws_s3_bucket_object" "faq" {
    ...
    etag = "${filemd5("../webpack/build/faq.html")}"
    cache_control = "max_age=86400"
    content_type = "text/html"
}
...
resource "aws_s3_bucket_object" "index" {
    ...
    etag = "${filemd5("../webpack/build/index.html")}"
    cache_control = "max_age=86400"
    content_type = "text/html"
}
...
resource "aws_s3_bucket_object" "resources" {
    ...
    etag = "${filemd5("../webpack/build/resources.html")}"
    cache_control = "max_age=86400"
    content_type = "text/html"
}
...
resource "aws_s3_bucket_object" "styles" {
    ...
    etag = "${filemd5("../webpack/build/css/styles.css")}"
    cache_control = "max_age=86400"
...
resource "aws_s3_bucket_object" "town_data" {
    ...
    etag = "${filemd5("../webpack/build/data/ma-towns.topojson")}"
    cache_control = "max_age=86400"
...
resource "aws_s3_bucket_object" "img_hero" {
    ...
    etag = "${filemd5("../webpack/build/img/hero.jpg")}"
...
resource "aws_s3_bucket_object" "img_logo" {
    ...
    etag = "${filemd5("../webpack/build/img/cce.png")}"
    cache_control = "max_age=31536000"
...
resource "aws_s3_bucket_object" "img_favicon" {
    ...
    etag = "${filemd5("../webpack/build/img/favicon.ico")}"
    cache_control = "max_age=31536000"
...
resource "aws_s3_bucket_object" "img_negef" {
    ...
    etag = "${filemd5("../webpack/build/img/negef.png")}"
    cache_control = "max_age=31536000"
    content_type = "image/png"
}
...
resource "aws_s3_bucket_object" "img_poster_thumb" {
    ...
    etag = "${filemd5("../webpack/build/img/poster-thumb.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_bcan" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/bcan.png")}"
    cache_control = "max_age=31536000"
    content_type = "image/png"
}
...
resource "aws_s3_bucket_object" "endorsement_bsac" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/bsac.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_clampoint" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/clampoint.png")}"
    cache_control = "max_age=31536000"
    content_type = "image/png"
}
...
resource "aws_s3_bucket_object" "endorsement_charlestown" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/charlestown.png")}"
    cache_control = "max_age=31536000"
    content_type = "image/png"
}
...
resource "aws_s3_bucket_object" "endorsement_ward4" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/ward4.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_carol_oldham" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/carol_oldham.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_michael_orr" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/michael_orr.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_jenny_sazama" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/jenny_sazama.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_joel_wool" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/joel_wool.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_kalila_barnett" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/kalila_barnett.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_matt_omalley" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/matt_omalley.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_annissa_essaibi_george" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/essaibi-george.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_ayanna_pressley" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/pressley.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_andrea_campbell" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/campbell.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_josh_zakim" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/zakim.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_tito_jackson" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/tito_jackson.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_michelle_wu" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/michelle_wu.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_rev_mariama_white_hammond" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/rev_mariama_white_hammond.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_sierra_mass" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/sierra-mass.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_nabb" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/nabb.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_boston_globe" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/boston-globe.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_bcec" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/bcec.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_wrse" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/wrse.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_roslindale" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/roslindale.jpg")}"
    cache_control = "max_age=31536000"
    content_type = "image/jpeg"
}
...
resource "aws_s3_bucket_object" "endorsement_jpnc" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/jpnc.png")}"
    cache_control = "max_age=31536000"
    content_type = "image/png"
}
...
resource "aws_s3_bucket_object" "endorsement_arborway" {
    ...
    etag = "${filemd5("../webpack/build/img/endorsements/arborway-coalition.png")}"
    cache_control = "max_age=31536000"
    content_type = "image/png"
}
...
resource "aws_s3_bucket_object" "robots" {
    ...
    etag = "${filemd5("../webpack/build/robots.txt")}"
...
resource "aws_s3_bucket_object" "west_rox_rosl_bulletin" {
    ...
    etag = "${filemd5("../webpack/build/pdf/West_Rox_Rosl_June_08_2017.pdf")}"
    cache_control = "max_age=31536000"
